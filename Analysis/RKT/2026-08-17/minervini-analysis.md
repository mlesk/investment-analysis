# Rocket Companies, Inc. (NYSE: RKT) — Minervini / SEPA Trading Analysis

**Date:** 2026-08-17 · **Price:** $14.50 (close Aug 17, 2026; after-hours $14.44) [1]
**Lens:** Mark Minervini — Specific Entry Point Analysis (SEPA), Trend Template, Stage analysis, VCP. This is a TRADING/technical view, not an intrinsic-value DCF.

---

## Bottom Line (Verdict First)

**Trading Rating: C — WATCHLIST (not actionable today). Action: "No setup — watch only."**

RKT is the rare case of a **fundamentally inflecting story** — record 6.2% purchase / 14.3% refi share, the most profitable quarter in four years (Q2'26 adj EBITDA margin 28%, adj EPS $0.16), and analyst EPS forecasts set to grow ~+121% in FY26 [3][7][8] — colliding with a **technically broken chart**. The stock is −11.3% below its 200-day SMA, −7.1% below its 150-day SMA, has not closed above the 200-day in the last 20 sessions, is down −21.75% over 52 weeks while the S&P 500 is up ~+22% (a ~44-point laggard), and sits −40.5% below its 52-week high [1][2][4][5]. Against Minervini's eight-point Trend Template this scores **1/8** — a Stage 1 basing stock, not a Stage 2 leader. There is **no valid entry point today**: price is mid-base, overhead supply runs $15.2–$16.4, the 200-day is still falling, and no completed VCP or breakout pivot exists. The bull catalyst (a Fed pivot → refi wave on a $2T servicing book, 26% of MSR above 6% note rates) is real but **speculative/unconfirmed** [6][7]. Buying $14.50 here offers ≈0.8:1 risk/reward against the $12.17 base floor. This becomes a Minervini trade only if/when price breaks the **$16.40 pivot** (200-day + base top) on strong volume, or constructs a tighter VCP. Great company ≠ great trade — today.
...
**Stage classification: Stage 1 (early accumulation/basing) — not Stage 2.** The stock made a 52-week high of $24.36 on Jan 16, 2026, declined ~50% to a June 8 low of $12.17, and has since oscillated in a roughly $12.2–16.4 range (Mar–Aug 2026) [4]. The 200-day is still above price and falling, and the last 20 sessions have all closed below it. Per the profile: Stage 1 is "not yet actionable for a standard Minervini breakout trade."
...
- **52-week price change: −21.75%** [2] vs **S&P 500 (SPY) +22.3%** over the same window (SPY $776.34, 52-wk range $629.28–$779.37, ~−0.4% from its high) [5]. RKT has underperformed by roughly **44 percentage points**.
- The broad market is in a **Confirmed Uptrend** (S&P near its 52-week high) [5] — yet RKT is −40.5% from its own high. This is the definition of a **laggard**, the opposite of the "leader near its high" profile Minervini hunts for [profile].
- **Classification: Laggard** (with signs of emerging accumulation at the base lows, but not yet leadership). RS rank is far below the 70–90 band Minervini requires; RKT is not even close to making new highs while the market is.
...
- **$16.35** — 200-day SMA (overhead, still falling) [2][4]
- **$17.36–17.65** — Apr 21 / Mar 2026 swing highs [4]
- **$18.49** — Feb 27 swing high [4]
- **~$20–21** — upper analyst price-target zone (high PT $21) [3]

Note the **descending base tops**: $17.65 (Mar) → $17.36 (Apr) → $15.86 (May) → $16.39 (Jul) → $15.18 (Aug 13). Price must clear $16.40 to negate the descending-top pattern [4].

---

## 5. Accumulation / Distribution & Volume

- **Earnings day Aug 6:** closed −4.6% ($13.86 → $13.22) on **40.1M shares** (vs ~31.5M 50-day avg) after gapping down — a distribution print that nonetheless **held $13.02** [4]. The Barron's headline "Rocket Stock Falls After Earnings and 'One of the Toughest Spring Housing Markets in Years'" captures the tape reaction [1].
- **Aug 7:** 42.1M volatile bounce (low $13.13 → close $13.72) [4].
- **Aug 13:** strong accumulation day — **+7.0% to $15.04 on 35.2M**, closing near the high, clearing the 50- and 100-day MAs [4].
- **Aug 14–17:** pullback on **shrinking volume** (18.9M, then 14.2M on Aug 17) — price down on declining volume = supply drying up (constructive) [4].
...
- **Structure:** A ~50% decline from the Jan 16 high ($24.36) to the Jun 8 low ($12.17), followed by ~5 months (Mar–Aug) of basing between roughly $12.2 and $16.4 — a **large, loose base** (~26% deep) with descending tops [4].
- **Recent contraction (last 3 weeks):** rally to $16.39 (Jul 1) → pullback to $12.57 (Jul 23, a ~23% correction) → bounce to $15.18 (Aug 13). Volatility remains high; there is **no successive tightening** of price ranges (the "18% → 12% → 7% → 4%" VCP signature is absent) [4].
- **VCP quality: D — no meaningful VCP yet.** Base quality: **C — constructive but incomplete/loose** (a first-stage base after a major decline, which is fine in principle, but it lacks contraction, and the 200-day overhead is unresolved).
- **Pivot:** **$16.40** — clears the 200-day ($16.35), the Jul 1 high ($16.39), and the Jun high ($16.25) simultaneously. This is the first legitimate Stage-2 buy point. A breakout must come on volume **≥ ~1.5× average** (≈42M+) and close strongly above the pivot to qualify [2][4].
- Near-term confirmation bar (lesser signal): a close above $15.18–15.86 would be a first positive step but is **not** a Minervini pivot while price remains below the 200-day.
...
- **Maximum chase:** ~$17.00 (+3.7% above pivot) [profile]
- **Initial stop:** $15.30 (below the 200-day/pivot support) → **risk $1.10/share ≈ 6.7%** (within Minervini's ≤7–8% guidance) [profile]
- **First target:** $18.50 (Feb swing high) → reward ≈ $2.10 → **~1.9:1**
...
**Why the market is not paying yet:** the stock **fell −4.6% on record Q2 results** (Aug 6) [4][1]. The market is pricing the shrinking mortgage market (Q3 guide $2.5–2.7B, down QoQ) more than the share gains [7]. That earnings-day reaction is a personality warning: good news is being sold, not bought — the opposite of a leader's behavior.
...
## 10. Final Trading Rating + Trade Quality Scorecard
...
- **200-day keeps falling** below ~$16 while price stalls → the base rolls lower rather than resolving up [4].
- **Fed stays on hold** through H1'27 → refi catalyst stays speculative; stock grinds in range.

---

## Sources

1. **StockAnalysis — RKT overview** — https://stockanalysis.com/stocks/rkt/ — price $14.50 (−1.76% Aug 17, 2026; after-hours $14.44), volume 18.38M, 52-wk range $12.17–$24.36, beta 2.21, market cap, 17 analysts Buy / PT $17.70, earnings date Aug 6, 2026, headline feed (Barron's "Rocket Stock Falls After Earnings…", WSJ "Rocket Revenue Surges…", Redfin housing reports).
2. **StockAnalysis — RKT statistics** — https://stockanalysis.com/stocks/rkt/statistics/ — 50-day SMA $14.03, 200-day SMA $16.35, RSI 53.96, short interest 98.68M (prior 104.02M; 5.21% float; 3.23 days), 52-wk change −21.75%, PE/fwd PE, shares 2.83B, institutions 34.23%.
3. **StockAnalysis — RKT forecast** — https://stockanalysis.com/stocks/rkt/forecast/ — 17 analysts, consensus Buy, PT low $14 / avg $17.70 / median $18 / high $21; post-earnings actions (JPM $16→$14 Aug 11, RBC $15→$16 Aug 12, KBW $20→$19 Aug 10, MS $19 Aug 7, BTIG n/a); FY26 EPS $0.62 (+120.95%), FY27 $0.87 (+40.5%), FY26 revenue $10.95B (+54.9%).
4. **Yahoo Finance chart API — RKT 1y daily OHLC** — https://query1.finance.yahoo.com/v8/finance/chart/RKT?range=1y&interval=1d — daily OHLC/volume for swing points, base structure, volume analysis; 150-day SMA $15.61 computed from this series; 200-day slope −0.16/10 sessions; 0/20 sessions above 200-day; earnings-day (Aug 6) −4.6% on 40.1M vol; Aug 13 +7.0% on 35.2M vol; Aug 14/17 18.9M/14.2M.
5. **Nasdaq API — SPY (S&P 500) summary** — https://api.nasdaq.com/api/quote/SPY/summary?assetclass=etf — SPY $776.34, 52-wk range $629.28–$779.37, 1-yr weighted alpha +22.32% (market-environment / relative-strength benchmark).
6. **Freddie Mac Primary Mortgage Market Survey** — https://www.freddiemac.com/pmms — 30-yr fixed 6.67% as of Aug 13, 2026 (6.69% prior week; 6.58% a year ago); 15-yr 5.96%.
7. **Rocket Q2 2026 earnings call transcript (via StockAnalysis)** — https://stockanalysis.com/stocks/rkt/transcripts/662740-q2-2026/ — record share 6.2%/14.3%, adj rev $2.76B, adj EBITDA $766M (28%), adj EPS $0.16, $2T servicing UPB, 26% MSR >6%, 57% serviced clients refi-prime, $300B capacity, Q3 guide $2.5–2.7B, "toughest spring housing market in years," $400M+ synergies (from shared fact pack).
8. **Rocket Q2 2026 press release (PR Newswire)** — https://www.prnewswire.com/news-releases/rocket-companies-announces-second-quarter-2026-results-302845358.html — total revenue $2.78B, GAAP NI $229M, adjusted NI $441M (from shared fact pack).
...
- **Rating:** **C — WATCHLIST** (not actionable today). Action: "No setup — watch only." Great company, wrong chart — the fundamental inflection does not override the broken technical trend.
- **Intrinsic value:** n/a — trading/technical lens, no DCF.
- **Trend status:** **Stage 1** (early basing below a falling 200-day). Minervini Trend Template **1/8** — long-term uptrend NOT established. Relative strength: **laggard** (−21.75% 52-wk vs S&P +22.3%).
